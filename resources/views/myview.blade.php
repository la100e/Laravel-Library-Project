        ...
        function Afficher() {
            ...
            xhttp.onreadystatechange = function () {
                if (xhttp.readyState == 4 && xhttp.status == 200) {
                    ...
                    document.write('<link rel="stylesheet" href="{{ asset('css/bootstrap.css') }}"><table class="table table-striped w-100"><tr><th>ISBN</th><th>Titre</th><th>Prix</th><th>Description</th></tr>');
            ...
            xhttp.open("GET", "{{route('livres.ajax')}}", true);
            xhttp.send();
        }
